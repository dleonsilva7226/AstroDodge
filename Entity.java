...
public abstract class Entity {
    ...
    public boolean isCollidingWith(Entity other){
        if (this.getX() > other.getWidth() + other.getX()) {
            return false;
        }
        if (this.getY() > other.getHeight() + other.getY()) {
            return false;
        }
        if (this.getWidth() + this.getX() < other.getX()) {
            return false;
        }
        if (this.getHeight() + this.getY() < other.getY()) {
            return false;
        }
        return true;  
    }
